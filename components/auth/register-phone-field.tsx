        ...
        >
          ...
          <Combobox.Portal>
            <Combobox.Positioner
              ...
              sideOffset={6}
            >
              <Combobox.Popup className="w-[min(360px,calc(100vw-32px))] overflow-hidden rounded-[22px] border border-border-subtle bg-surface-overlay p-2 shadow-[var(--surface-shadow-floating)] outline-none backdrop-blur-2xl">
