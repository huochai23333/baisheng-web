...
export function useAdminOrdersViewModel({
  ...
  return {
    ...
    exitExactAllTimeSearch: routeState.exitExactAllTimeSearch,
    ...
    handleDatePresetChange: routeState.handleDatePresetChange,
    ...
    searchExactOrderAllTime: routeState.searchExactOrderAllTime,
