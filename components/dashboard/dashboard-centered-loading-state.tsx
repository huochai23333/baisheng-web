...
export function DashboardCenteredLoadingState({
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] w-full max-w-[1320px] items-center justify-center">
      <div className="motion-surface-enter flex items-center gap-3 rounded-[28px] border border-white/85 bg-white/72 px-6 py-5 text-sm text-content-muted shadow-[var(--surface-shadow-interactive)]">
