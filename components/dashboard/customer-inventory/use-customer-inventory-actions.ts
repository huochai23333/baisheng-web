...
function getInventoryErrorMessage(error: unknown) {
  ...
  const mappings: Array<[string, string]> = [
    ...
    ["items_count_invalid", "每笔订单需要填写1至100件商品。"],
    ["item_invalid", "请检查商品名称、正整数数量和1688货品链接。"],
    ...
    [
      "fixed_200_already_qualified",
      "该客户已经获得200美元长期使用资格，请由业务员或管理员直接启用。",
    ],
    ["credit_decisions_incomplete", "请处理这笔订单的全部待审信贷档位。"],
