    ...
    <DashboardPageShell>
      <div className="rounded-[28px] border border-white/90 bg-[#f4f3f1]/92 p-6 shadow-[0_18px_45px_rgba(96,113,128,0.08)] xl:p-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-3">
            <div className="motion-skeleton h-6 w-28 rounded-full bg-[#dfe8ee]" />
            <div className="motion-skeleton h-10 w-64 max-w-full rounded-full bg-[#e7edf2]" />
      ...
      <div className="grid gap-6 xl:grid-cols-[1.6fr_1fr]">
        <div className="space-y-6 rounded-[28px] border border-white/85 bg-white/72 p-6 shadow-[0_18px_45px_rgba(96,113,128,0.06)] xl:p-8">
          <div className="motion-skeleton h-8 w-56 max-w-full rounded-full bg-[#ebeff2]" />
        ...
        <div className="space-y-4 rounded-[28px] border border-white/85 bg-white/72 p-6 shadow-[0_18px_45px_rgba(96,113,128,0.06)] xl:p-8">
          <div className="motion-skeleton h-8 w-40 rounded-full bg-[#ebeff2]" />
          <SkeletonBlock />
          <SkeletonBlock />
          <SkeletonBlock />
        </div>
...
function SkeletonCard() {
  return (
    <div className="rounded-[24px] border border-[#ebe7e1] bg-[#fbfaf8] p-5 shadow-[0_10px_24px_rgba(96,113,128,0.04)]">
      <div className="motion-skeleton h-4 w-24 rounded-full bg-[#e3e9ee]" />
      <div className="motion-skeleton mt-4 h-24 rounded-[18px] bg-[#eef2f5]" />
      <div className="motion-skeleton mt-4 h-4 w-32 rounded-full bg-[#e3e9ee]" />
    </div>
  );
}

function SkeletonBlock() {
  return <div className="motion-skeleton h-20 rounded-[20px] bg-[#eef2f5]" />;
}
